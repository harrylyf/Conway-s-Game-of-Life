...
public class cells_board {
	...
	public cells_board(int dimension, int lb, int hb, int ls, int hs) {
	...
	public int[][] updateNextGeneration_torus(int[][] status_board) {
		...
		for (int i = 0; i < m; i++) {
			for (int j = 0; j < n; j++) {
				...
				// torus check
				lives += torus_surrounding_check(lives, i, j, m, n, status_board);

				// normal check
				lives += normal_surrounding_check(lives, i, j, m, n, status_board);
	...
	public int torus_surrounding_check(int lives, int i, int j, int m, int n, int[][] status_board) {
		if (i == 0) {
			if(j == 0) {
	...
	public int normal_surrounding_check(int lives, int i, int j, int m, int n, int[][] status_board) {
		// check upper
		if (i > 0) {
